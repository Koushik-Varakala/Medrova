...
import { z } from "zod";
import { ArrowRight, ArrowLeft, Loader2, AlertCircle, CheckCircle2, User, Stethoscope, FileText, Calendar, IndianRupee, Upload, X, ChevronDown } from "lucide-react";
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-6 border-t border-slate-200 mt-6">
                      ...
                      <details className="mt-4 group/terms border border-slate-200 rounded-xl overflow-hidden">
                        <summary className={cn("text-xs font-bold cursor-pointer p-3 list-none flex justify-between items-center transition-colors", colors.bg, colors.text)}>
                        ...
                        <div className="flex items-center justify-between bg-slate-50 border-t border-slate-200 px-4 py-3">
                          ...
                          <a
                            ...
                            className={cn("flex items-center gap-1.5 text-xs font-bold hover:underline", colors.text)}
                          >
